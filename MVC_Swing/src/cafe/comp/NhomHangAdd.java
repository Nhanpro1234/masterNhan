...
public class NhomHangAdd extends JFrame implements ActionListener, KeyListener {
	 ...
	 * Create the frame.
	 */
	public NhomHangAdd(SanPham sanPham) {
	...
	public void add(int type) {
		if(path.getText().equals("") || tenNhom.getText().equals("")) {
		...
		if(result.isEmpty()) {
			...
			String[] getmaNH = result.get(result.size() - 1).getMaNhom().split("_");
			
			maNhom = getmaNH[0] + "_" + (Integer.parseInt(getmaNH[1]) + 1);
		}
