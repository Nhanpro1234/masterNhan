...
public class DanhMucSanPhongBanEdit extends JFrame implements ActionListener{
	 ...
	 * Create the frame.
	 */
	public DanhMucSanPhongBanEdit(DanhMucSanPhongBan danhMucSanPhongBan, String maSPB) {
		this.maSPB = maSPB;
